...
c     ehbmax      maximum value of Hbond potentials
c     hbondmin    distance of Hbond minimum
c     cghbondcutoff  cutoff for Hbond distance
c
      module vdwpot
      implicit none
      integer maxgauss
      ...
      character*13 vdwtyp
c #### Added by David Commented 01/03/17
c      real*8 ehbmax,hbondmin
c      real*8 cghbondcutoff
