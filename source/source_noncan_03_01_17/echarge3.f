...
c     #################################################################
c     ##                                                             ##
c     ##  subroutine echarge3dh  --  charge analysis via double loop  ##
c     ##                                                             ##
c     #################################################################
c
c
c     "echarge3dh" calculates the charge-charge interaction energy
c     and partitions the energy among the atoms using Debye-Huckel 
c     approximaion
c
c
      subroutine echarge3dh
      use sizes
      use action
      use analyz
      use atoms
...
c      real*8 rc5,rc6,rc7,kdebyescreen
      real*8 rc5,rc6,rc7
