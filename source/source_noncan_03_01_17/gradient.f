...
c
c############## Added by David #############*subroutines NOT files
c      if (use_debyehuckel) call echarge1dh Commented 02/06/16
      if (use_debyehuckel) call echarge1

      if (use_charge .AND. .NOT. use_debyehuckel)  call echarge1
c####################################################
