...
c
c############## Added by David ######################
c      if (use_debyehuckel) call echarge3dh Commented 02/06/16
      if (use_debyehuckel) call echarge3

      if (use_charge .AND. .NOT. use_debyehuckel)  call echarge3
c####################################################
c      if (use_charge)  call echarge3
...
c
c  ##### Added by David 04/22/16 ####
c     call the CG hbond routines

      if (use_cghbond) call ecghbond3
