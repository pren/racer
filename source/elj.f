...
c     ##################################################################
c     ##                                                              ##
c     ##  subroutine elj0_lp  --  double loop Lennard-Jones vdw energy  ##
c     ##                                                              ##
c     ##################################################################
c
c
c     "elj0_lp" calculates the Lee-pings Lennard-Jones 4-8 van der Waals energy
...
c                     write(*,*) "Lennard-Jones LP is working"
                     lpterm = (3 / (lpfact + 3))
                     e = (2 * eps / (1 - lpterm))
     &                          * (sigv**6/(sigv**6 + rik2**3))
     &                          * (lpterm * exp(lpfact*(1-(rik/sigv))) 
