...
c     ##                                                           ##
c     ##                                                           ##
c     ##  subroutine echarge0dh  --  charge energy via Debye Huckle  ##
c     ##                                                           ##
c     ##                                                           ##
c     ###############################################################
c     ###############################################################
...
c
c
c     "echarge0dh" calculates the charge-charge interaction energy
c     using Debye Huckle approximation
c
      subroutine echarge0dh
      use sizes
      use atoms
      use bound
      use cell
...
c     real*8 cscale(maxatm)
c     integer NTHREADS, OMP_GET_NUM_THREADS
c
...
!$OMP& x,y,z,f,pchg,n12,n13,n14,n15,i12,i13,i14,i15,
!$OMP& c2scale,c3scale,c4scale,c5scale,use_group,use_bounds,off2,
!$OMP& ebuffer,kdebyescreen)
