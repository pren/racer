...
c     ################################################################
c     ##                                                            ##
c     ##  subroutine echarge2dh  --  charge Hessian via debye-huckel  ##
c     ##                                                            ##
c     ################################################################
c
c
c     "echarge2dh" calculates second derivatives of the charge-charge
c     interaction energy for a single atom using debye-huckel
c
c
      subroutine echarge2dh (i)
      use sizes
      use atoms
      use bound
      use cell
      ...
      real*8 r,rb,rb2
      real*8 r2,r3,r4
c      real*8 r5,r6,r7,kdebyescreen
      real*8 r5,r6,r7
      real*8 term(3,3)
...
c
               ...
               d2e = e*(2*1/rb2 + 2/rb/kdebyescreen
     &                    + 1/kdebyescreen/kdebyescreen)
c
c     use shifted energy switching if near the cutoff distance
c
c               if (r2 .gt. cut2) then
c                  e = fik / r
...
c                  r6 = r3 * r3
c                  r7 = r3 * r4
c                  taper = c5*r5 + c4*r4 + c3*r3 + c2*r2 + c1*r + c0
c                  dtaper = 5.0d0*c5*r4 + 4.0d0*c4*r3
c     &                        + 3.0d0*c3*r2 + 2.0d0*c2*r + c1
c                  d2taper = 20.0d0*c5*r3 + 12.0d0*c4*r2
c     &                         + 6.0d0*c3*r + 2.0d0*c2
c                  trans = fik * (f7*r7 + f6*r6 + f5*r5 + f4*r4
c     &                            + f3*r3 + f2*r2 + f1*r + f0)
c                  dtrans = fik * (7.0d0*f7*r6 + 6.0d0*f6*r5
c     &                            + 5.0d0*f5*r4 + 4.0d0*f4*r3
c     &                            + 3.0d0*f3*r2 + 2.0d0*f2*r + f1)
c                  d2trans = fik * (42.0d0*f7*r5 + 30.0d0*f6*r4
c     &                             + 20.0d0*f5*r3 + 12.0d0*f4*r2
c     &                             + 6.0d0*f3*r + 2.0d0*f2)
c                  d2e = e*d2taper + 2.0d0*de*dtaper
c     &                     + d2e*taper + d2trans
c                  de = e*dtaper + de*taper + dtrans
c               end if
c
