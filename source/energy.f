...
c############## Added by David ######################
c      if (use_debyehuckel) call echarge0dh Commented 02/06/16
      if (use_debyehuckel) call echarge

      if (use_charge .AND. .NOT. use_debyehuckel)  call echarge
c####################################################
