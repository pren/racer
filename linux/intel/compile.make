...
ifort -c -O3 -xHost -no-ipo -no-prec-div -openmp ecghbond.f
ifort -c -O3 -xHost -no-ipo -no-prec-div -openmp ecghbond1.f
ifort -c -O3 -xHost -no-ipo -no-prec-div -openmp ecghbond2.f
ifort -c -O3 -xHost -no-ipo -no-prec-div -openmp ecghbond3.f
